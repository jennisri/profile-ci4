			...
			<div class="card-body">
				<div class="card mb-4">
					...
					<div class="card-body">
						...
						<form action="/daftarproduk/update/<?php echo $data_produk->id_produk ?>" method="post" enctype="multipart/form-data">
							<?php echo csrf_field(); ?>

							<input type="hidden" name="_method" value="PUT">
							<input type="hidden" name="gambar_lama" value="<?php echo $data_produk->gambar_produk ?>">

							<div class="row">
								<div class="mb-3 col-6">
									<label for="nama_produk">Nama Produk</label>
									<input type="text" name="nama_produk" id="nama_produk" class="form-control <?php echo $validation->hasError('nama_produk') ? 'is-invalid' : null ?>" value="<?php echo old('nama_produk', $data_produk->nama_produk); ?>">
							...
							<div class="row">
								<div class="mb-3 col-6">
									...
									<textarea name="deskripsi" id="" cols="30" rows="10" class="form-control <?php echo $validation->hasError('deskripsi') ? 'is-invalid' : null ?>"><?php echo old('deskripsi', $data_produk->deskripsi) ?></textarea>
								...
								<div class="mb-3 col-6">
									...
									<div class="col-sm-10">
										<div class="custom-file">
											...
											<div class="col-sm-3">
												<img src="/assets-admin/img/<?php echo $data_produk->gambar_produk ?>" class="img-thumbnail img-preview mt-2" alt="">
											</div>
										</div>
									</div>
								</div>
