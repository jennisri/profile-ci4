      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <?php foreach ( $data_slider as $slider ) : ?>
            <div class="carousel-item active" style="background-image: url(/assets-admin/img/<?php echo $slider->gambar_slider ?> );">
              <div class="carousel-container">
                <div class="carousel-content">
                  <h2 class="animate__animated animate__fadeInDown"><?php echo  $slider->judul_slider ?></h2>
        ...
        <div class="row">
          <?php foreach ( $data_team as $team ) : ?>
            <div class="col-xl-3 col-lg-4 col-md-6">
              <div class="member">
                <img src="/assets-admin/img/<?php echo $team->gambar_team ?>" class="img-fluid " alt="" width="100%" height="50%">
                <div class="member-info">
                  <div class="member-info-content">
                    <h4><?php echo  $team->nama ?></h4>
                    <span><?php echo  $team->jabatan ?></span>
                  </div>
                  <div class="social">
                    <a href="<?php echo $team->fb ?>"><i class="bi bi-facebook"></i></a>
                    <a href="<?php echo $team->ig ?>"><i class="bi bi-instagram"></i></a>
                  </div>
                </div>
              </div>
            </div>
